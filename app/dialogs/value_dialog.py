...
class ValueDialog(wx.Dialog):
    def __init__(self, parent, columns, model, attr, **kwargs):
        ...
        self.valueTextCtrl = wx.TextCtrl(buttonSizer.GetStaticBox(), value='')
        buttonSizer.Add(self.valueTextCtrl, 0, wx.EXPAND)
        addBtn = wx.Button(buttonSizer.GetStaticBox(), wx.ID_ANY, label='Add')
        buttonSizer.Add(addBtn, 0, wx.ALL, 2)
        saveBtn = wx.Button(buttonSizer.GetStaticBox(), wx.ID_ANY, label='Save')
        buttonSizer.Add(saveBtn, 0, wx.ALL, 2)
        deleteBtn = wx.Button(buttonSizer.GetStaticBox(), wx.ID_ANY, label='Delete')
        ...
        importBtn = wx.Button(buttonSizer.GetStaticBox(), wx.ID_ANY, label='Import')
        buttonSizer.Add(importBtn, 0, wx.ALL, 2)
        importBtn.Bind(wx.EVT_BUTTON, self.importValues)
        hsizer.Add(buttonSizer, 1, wx.RIGHT, 5)
